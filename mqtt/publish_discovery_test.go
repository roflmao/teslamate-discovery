...
func TestMQTT_PublishDiscovery(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []string{
				"test-discovery-prefix/sensor/test-id/charge_current_request/config",
				"test-discovery-prefix/sensor/test-id/charge_current_request_max/config",
				...
				"test-discovery-prefix/sensor/test-id/charger_phases/config",
				...
				"test-discovery-prefix/sensor/test-id/charging_state/config",
				...
				"test-discovery-prefix/sensor/test-id/exterior_color/config",
				"test-discovery-prefix/sensor/test-id/spoiler_type/config",
				"test-discovery-prefix/sensor/test-id/wheel_type/config",
				"test-discovery-prefix/sensor/test-id/display_name/config",
				"test-discovery-prefix/sensor/test-id/battery/config",
				"test-discovery-prefix/sensor/test-id/usable_battery/config",
				"test-discovery-prefix/sensor/test-id/center_display/config",
				"test-discovery-prefix/binary_sensor/test-id/charge_port/config",
				"test-discovery-prefix/binary_sensor/test-id/doors/config",
				"test-discovery-prefix/binary_sensor/test-id/door_driver_front/config",
				"test-discovery-prefix/binary_sensor/test-id/door_driver_rear/config",
				...
				"test-discovery-prefix/binary_sensor/test-id/door_passenger_front/config",
				"test-discovery-prefix/binary_sensor/test-id/door_passenger_rear/config",
				"test-discovery-prefix/sensor/test-id/range/config",
				"test-discovery-prefix/binary_sensor/test-id/sentry_mode/config",
				"test-discovery-prefix/sensor/test-id/shift_state/config",
				"test-discovery-prefix/sensor/test-id/state/config",
				"test-discovery-prefix/sensor/test-id/since/config",
				...
				"test-discovery-prefix/binary_sensor/test-id/tire_soft_front_left/config",
				"test-discovery-prefix/binary_sensor/test-id/tire_soft_front_right/config",
				"test-discovery-prefix/binary_sensor/test-id/tire_soft_rear_left/config",
				"test-discovery-prefix/binary_sensor/test-id/tire_soft_rear_right/config",
